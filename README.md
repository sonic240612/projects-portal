...
제가 만든 서비스들(LADDER, open-survivor, TikaTuka, HueWorld, zen_pebble)을 한 번에 확인할 수 있는 포털 페이지입니다.
...
| zen_pebble | 디지털 인내심 테스트 | [바로가기](https://github.com/sonic240612/zen_pebble) | [바로가기](https://zen-pebble.vercel.app) |

## 기능

- **Simple 테마** — Light / Dark 모드 전환 지원
- **Animated 테마** — 파티클 효과와 함께하는 다크 스타일
- 테마 전환 상태는 `localStorage`에 저장되어 유지됨
